...
<div class="prefooter">
	<div class="footer">
		<div class="row-start">
			...
			<?php if($_SESSION['level'] > '1') { echo '<div style="margin-top: 15px;"><a href="organization">Новая организация</a></div>
				<div><a href="export_catalog">Экспортный каталог</a></div>';}
				if($_SESSION['level'] >= '1') { echo '<div><a href="organization_updating">Существующая организация</a></div>';} ?>
				<div><a href="status_check">Отслеживание статуса организации в системе</a></div>
				<?php if($_SESSION['level'] >= '1') { echo '<br><br><br>
				<span>Продукция</span>
				<div style="margin-top: 15px;"><a href="searching">Изменить существующую организацию</a></div>';}?>
			</div>
			<?php if($_SESSION['level'] >= '2'){ echo '
			<div class="row_footer">
				<span>Муниципальные образования</span>
				<div style="margin-top: 15px;"><a href="muno">Руководители муниципального образования</a></div>
				<div><a href="muno">Ответственные за экспорт в муниципальном образовании</a></div>
			</div>';}?>
			<?php if($_SESSION['level'] == '3') { echo '
			<div class="row_footer">
				<span>Дополнительно</span>
				<div style="margin-top: 15px;"><a href="history_success">Истории успеха</a></div>
				<div style="margin-top: 15px;"><a href="mailing">Рассылка по участникам системы</a></div>
			</div>';}?>
			<div class="row_footer">
