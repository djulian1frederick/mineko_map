...
move_uploaded_file($_FILES['upload']['tmp_name'], "../../news_attach/".$name);
$full_path = $_SERVER['DOCUMENT_ROOT'].'/news_attach/'.$name;
$message = "Файл ".$_FILES['upload']['name']." загружен";
$size=@getimagesize('../../news_attach/'.$name);
if($size[0]<50 OR $size[1]<50){
unlink('../../news_attach/'.$name);
