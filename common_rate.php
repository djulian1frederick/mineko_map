...
do {
    ...
    $idmo = $idmo['id_mo'];
    $count_pred = mysqli_query($bd, "SELECT COUNT(*) from predpriyatiya where id_mo = '".$idmo."'");
...
var ctx = document.getElementById('common_rate').getContext('2d');
var common_rate = new Chart(ctx, {
    type: 'bar',
    data: {
...
common_rate.canvas.parentNode.style.height = 'auto';
common_rate.canvas.parentNode.style.width = 'auto';
</script>
