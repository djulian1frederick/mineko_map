<?php
			require_once('admin/connection.php');
				$id = $_POST['id'];
				$sql_select_map = "SELECT * from mo join raions join rukovoditeli where mo.id_raion = raions.id_raion and mo.id_rukovod=rukovoditeli.id_rukovoditel and mo.id_raion='".$id."'";
