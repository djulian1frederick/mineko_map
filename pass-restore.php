<div id="popup" style="display: none;">
	...
	<div class="popup" style="height: 250px;">
		<div style="height: 200px;">
			...
			<p style="color: #f43038; font-size: 16px; font-family: Circe Light;">Для того, чтобы сбросить пароль, введите в поле ниже e-mail, который был использован для регистрации</p>
